...
export const SUBAGENT_SPAWN_PARAMETER_DESCRIPTIONS = {
  ...
  model:
    'Model hint: "provider/model-id" or bare model id. Omit to inherit the parent session\'s model.',
  reasoningEffort:
    "Reasoning effort (pi thinking level): off, minimal, low, medium, high, xhigh, max. Omit to inherit the parent session's level.",
};
